...
with col_ketiga:
  ...
  fig_akurasi_twitter=px.line(data_akurasi_twitter,x=data_akurasi_twitter['model'],y=data_akurasi_twitter['akurasi'],markers=True,color='model')
  fig_akurasi_twitter.update_layout(title='Algoritma Akurasi Twitter')
  fig_akurasi_algoritma=px.line(data_akurasi_algoritma,x=data_akurasi_algoritma['model'],y=data_akurasi_algoritma['akurasi'],markers=True,color='model')

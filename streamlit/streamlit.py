...
with col_ketiga:
  ...
  fig_akurasi_algoritma.update_layout(title='Accuracy algorithm comparison on buyer comments on Tokopedia,buka lapak,shopee /n and lazada accounts e-commerce',xaxis_title="Model", yaxis_title="Accuracy")
  with st.container():

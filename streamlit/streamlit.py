...
hasil=pd.read_csv('C:\\Users\\andik\\Documents\\project\\Project NLP 1\\streamlit\\hasil.csv')
import plotly.express as px
...
f=open('C:\\Users\\andik\\Documents\\project\\Project NLP 1\\password_mongo.txt','r')
j=f.readlines()[0]
